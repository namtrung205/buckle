...
test('invalid regeneration rolls back and undo restores parameters plus graph', () => {
  ...
  const invalid = planFrame(document, { length: 10, bays: 2, sectionId: 999 }, initial.object.id)
  assert.throws(() => execute(gateway, document, 'invalid-section', invalid.command), /Unknown section id 999/)
